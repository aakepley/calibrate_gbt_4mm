pro wonoff_cal,twarm=twarm,tcold=tcold,plnum=plnum,fdnum=fdnum,ifnum=ifnum,son,soff,swarm,scold
;
;;Computes and calibrate using gettp for W-band and performs vector
;;calibration of data.  If baselines are bad, try scalar calibration, e.g.,
;;wonoff_gain.pro
;
;;son = on scan
;;soff = off scan
;;plnum = pol-number
;;fdnum = beam-number
;;swarm = warm scan for fdnum
;;scold = cold scan for fdnum
